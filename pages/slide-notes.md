...
Digital text&mdash;on a browser, in a Word document&mdash;separates the *content* of what you're writing from *how it looks*.
...
# CSS Selectors <!-- talking to HTML with CSS? -->
